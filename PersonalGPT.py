    ...
    tools = [
        {
            ...
            'function': {
                'name': 'speak_gpt',
                'description': f'Use this function to generate audio speech for your answers. {st.session_state.speak_prompt}',
                'parameters': {
                    'type': 'object',
                    'properties': {
                        'message': {
